...
//   const [outputFiles, setOutputFiles] = React.useState(null);
...
//                       <a
//                         href={`http://127.0.0.1:8000/download/${outputFiles.batch}/${outputFiles.scores}`}
//                         style={downloadButtonStyle}
//                       >
//                         Download Scores
//                       </a>
//                       <a
//                         href={`http://127.0.0.1:8000/download/${outputFiles.batch}/${outputFiles.analysis}`}
//                         style={downloadButtonStyle}
//                       >
//                         Download Analysis
//                       </a>
              ...
              <div style={contentWrapperStyle}>
                {isLoading ? (
                  ...
                  <div style={resultsContainerStyle}>
                    ...
                    <div style={downloadButtonsContainerStyle}>
                      <a
                        href={`http://127.0.0.1:8000/download/${outputFiles.batch}/${outputFiles.excelReport}`}
                        style={downloadButtonStyle}
